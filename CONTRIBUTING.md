...
This project uses the standard GitHub pull request workflow. To contribute, fork the repository, create a new branch, make your changes (documentation fixes are welcome!), and open a pull request back to this repo. Be sure to clearly describe what you changed and why.

If you’re new to GitHub, small and focused contributions are encouraged. A maintainer will review your pull request and may request minor changes before merging.
