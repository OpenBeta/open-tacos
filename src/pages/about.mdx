...
We pledge to keep climbers' generous contribution free and open, and do not have legal restrictions [preventing people from using the information](https://www.climbing.com/news/mountain-project-openbeta-and-the-fight-over-climbing-data-access/) in creative and productive ways.
...
Information for each climbing route/area is stored in a human-readable text file.
We purposely avoid complex database techonology, instead rely on many existing features of GitHub to help us keep track user edits.  Climbers can join an area admin group to help us review and approve changes.
