...
const UserProfileSchema = Yup.object().shape({
  nick: Yup.string()
    ...
    .test('special-rules', 'Must start and end with a letter or number, no spaces. Underscores, dots and hyphens are allowed but cannot be consecutive or at the beginning or end.', checkUsername),
  name: Yup.string()
