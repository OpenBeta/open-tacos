...
/**
 * Layout for edit climb dashboard
 */
export default async function EditClimbDashboardLayout ({
  children,
  params
}: {
    ...
    <div className='relative w-full h-full'>
      <div className='px-12 pt-8 pb-4'>
        ...
        <div className='text-sm flex justify-end'>
          {/* <a
            href={getAreaPageFriendlyUrl(uuid, areaName)}
      ...
      <div className='bg-base-200'>
        ...
        <div className='flex bg-base-200 flex-col lg:flex-row py-12'>
          <main className='relative h-full w-full px-2 lg:px-16'>{children}</main>
        </div>
      </div>
    </div>
  )
